...
const Register: React.FC = () => {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setLoading(true);
      const { token } = await authService.register(email, password, name || undefined);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4 relative">
      ...
      <div className="max-w-md w-full bg-white dark:bg-gray-800 p-8 rounded-lg shadow">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Start testing APIs visually.</p>
